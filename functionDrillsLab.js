...
// const compareNums = (num1, num2) =>(num1 >)
...
function faveColorFinder(color){
  if (color === `red`){
    ...
    return ` you need to eva;uate your favorite color choice`
  }
}
...
let remainingConstestants = theEliminator(contestants, loser)
console.log(remainingConstestants)
...
const sampleStringUp = str => {
  console.log(str.toUpperCase())
}
sampleStringUp(sampleString)
...
console.log(`you just purchased ${totalFrogs} chocolate frogs`)
////////////////// PROBLEM 20 ////////////////////
/*
...
console.log(`you just purchased ${totalFrogs2} chocolate frogs`)
...
arrayCheck(sampleArray)
console.log(arrayCheck(sampleArray))
